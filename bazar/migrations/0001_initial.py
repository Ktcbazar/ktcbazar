    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('agent', 'Agent'), ('staff', 'Staff'), ('employee', 'Admin')], default='customer', max_length=20)),
                ('referral_link', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('placement', models.CharField(blank=True, choices=[('1', '1'), ('2', '2'), ('3', '3'), ('4', '4')], max_length=20, null=True)),
