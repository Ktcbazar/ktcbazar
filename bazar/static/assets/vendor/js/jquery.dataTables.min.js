...
(function(l) {
    ...
    function ja(a, b) {
        ...
        if (-1 !== l.inArray(!1, c))
            ...
            var d = 0
              ...
              , m = a.aiDisplay;
            a.bDrawing = !0;
            g !== q && -1 !== g && (a._iDisplayStart = k ? g : g >= a.fnRecordsDisplay() ? 0 : g,
    ...
    function Ha(a) {
        ...
        if (a.scrollBarVis !== fa && a.scrollBarVis !== q)
            ...
            w.outerWidth() < h ? (la = g.scrollHeight > g.offsetHeight || "scroll" == n.css("overflow-y") ? h + b : h,
    ...
    function pb(a, b, c) {
        ...
        if (b && b.time) {
            ...
            0 < f && b.time < +new Date - 1E3 * f)
                ...
                b.start !== q && (a._iDisplayStart = b.start,
    ...
    var u = function(a, b) {
        ...
        c = null;
        return this
    }, M, y, J, sb = {}, gc = /[\r\n\u2028]/g, Ua = /<.*?>/g, uc = /^\d{2,4}[\.\/\-]\d{1,2}[\.\/\-]\d{1,2}([T ]{1}\d{1,2}[:\.]\d{2}([\.:]\d{2})?)?$/, vc = /(\/|\.|\*|\+|\?|\||\(|\)|\[|\]|\{|\}|\\|\$|\^|\-)/g, rb = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, Z = function(a) {
        return a && !0 !== a && "-" !== a ? !1 : !0
    }, hc = function(a) {
        var b = parseInt(a, 10);
    ...
    var Cc = function(a, b, c) {
        var d = a.aoData, e = Va(a, c), h = kc(Ea(d, e, "anCells")), f = l(lc([], h)), g, k = a.aoColumns.length, m, n, p, t, v, x;
